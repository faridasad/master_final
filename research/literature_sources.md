# Dissertasiya Üçün Təklif Edilən Ədəbiyyat Siyahısı (APA 7)

Aşağıdakı siyahı Google Scholar, ResearchGate və Academia.edu platformaları üzərindən "Şəhər nəqliyyat sistemlərində hərəkət axınlarının kompüterli modelləşdirilməsi və veb-əsaslı simulyasiya mühitinin işlənməsi" mövzusuna uyğun olaraq toplanmış, 2019-2024-cü illəri əhatə edən elmi məqalə, konfrans materialı və kitablara əsaslanır.

Bütün mənbələrin orijinal məqalələrinə və ya yükləmə səhifələrinə keçid üçün **[Link]** bölmələri əlavə edilmişdir.
